<template>
  <h2 class="intro-y text-lg font-medium mt-10">老师管理</h2>
      ...
      <div class="box">
        <div class="flex flex-col lg:flex-row items-center p-5">
          ...
          <div class="flex mt-4 lg:mt-0">
            <button class="btn btn-danger py-1 px-2 mr-2" @click="shenghe(faker)" v-if="faker.status==0">审核</button>
            <button class="btn btn-danger py-1 px-2 mr-2" v-else disabled>已审核</button>
